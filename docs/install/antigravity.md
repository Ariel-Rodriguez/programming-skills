# Installing on Antigravity

## Automatic Installation (Linux/macOS)

Run this command in your project root to download the standard skills to `.cursor/skills` (Antigravity is compatible with Cursor skill structure):
...
3. Configure your agent settings to reference these skills.
