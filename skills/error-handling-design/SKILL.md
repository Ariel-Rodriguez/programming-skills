...
description: Errors must be modeled explicitly in return types or error boundaries. Use when reviewing code with swallowed errors or try-catch without recovery.
---
